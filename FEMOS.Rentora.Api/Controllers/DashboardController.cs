...
namespace FEMOS.Rentora.Api.Controllers
{
    ...
    public class DashboardController : ControllerBase
    {
        ...
        /// </summary>
        /// <param name="propertyPublicId">The property ID for which to retrieve the dashboard</param>
        /// <param name="unitPublicId">The unit ID for which to retrieve the dashboard</param>
        /// <response code="200">Dashboard retrieved successfully</response>
        /// <response code="400">Invalid property ID</response>
        /// <response code="401">Unauthorized</response>
        [HttpGet]
        public async Task<IActionResult> GetDashboard(Guid propertyPublicId, Guid unitPublicId)
        {
            ...
            var dashboard = await _dashboardService.GetDashboardAsync(propertyPublicId, unitPublicId, userPublicId);
